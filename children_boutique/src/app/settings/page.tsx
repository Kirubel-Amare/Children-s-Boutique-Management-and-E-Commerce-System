    ...
    <ProtectedRoute>
      <SidebarLayout>
        <div className="max-w-6xl mx-auto py-6 px-4 sm:px-6 lg:px-8">
          ...
          {/* Alert Messages */}
          {message && (
            <AlertMessage type={message.type} message={message.text} onDismiss={clearMessages} />
          )}
          ...
          <div className="bg-white rounded-xl shadow border border-gray-200 overflow-hidden">
            ...
            <div className="border-b border-gray-200 overflow-x-auto whitespace-nowrap scrollbar-hide">
              <TabNavigation
                ...
                onTabChange={(tabId: string) =>
                  setActiveTab(tabId as "profile" | "security" | "preferences")
                }
              />
            </div>
            ...
            <div className="p-4 sm:p-6">
              {activeTab === "profile" && (
                <ProfileTab user={user} onUpdateProfile={handleUpdateProfile} updating={updating} />
              )}

              {activeTab === "security" && (
                <SecurityTab userEmail={user.email} onChangePassword={handleChangePassword} updating={updating} />
              )}
